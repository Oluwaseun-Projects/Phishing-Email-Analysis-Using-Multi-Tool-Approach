...
**Date Received:** Tue, 18 June 2024 08:17:56 +0000  
**To:** employee@example.com  
**From (Display Name):** Microsoft Support Team  
**From (Email):** support@micros0ft-reset.com  
**Return-Path:** noreply@micros0ft-reset.com (does **not** match sender — suspicious)  
**Sender IP Address:** 203.0.113.42  
**Resolved Hostname:** mail.fakehost.biz  
**IP Ownership:** Registered to a VPS provider in Eastern Europe (via WHOIS lookup)  
**SPF Result:** Fail (sender not authorized for domain)  
**Encoding:** base64  
**Second Extracted URL (defanged):** hxxps://account[.]micros0ft-reset[.]com/verify  
**VirusTotal Verdict (Fortinet):** Malicious – Phishing  

### 🔍 Final Verdict
**Is this email genuine?** ❌ **No**

> The email contains multiple indicators of phishing: forged sender address, failed SPF, use of spoofed domain, obfuscated URL, and malware-related verdict from Fortinet via VirusTotal.
